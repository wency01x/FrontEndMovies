  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url('/images/poppyhill.jpg')`
        }}
      />
      ...
      <div className="relative z-20 h-full text-white p-6 flex flex-col">
        ...
        <div className="flex mt-2 space-x-2 subtitle">
          <span className="bg-gray-800 bg-opacity-70 px-3 py-1 rounded-full text-xs">Slice-of-Life</span>
          <span className="bg-gray-800 bg-opacity-70 px-3 py-1 rounded-full text-xs">Drama</span>
          <span className="bg-gray-800 bg-opacity-70 px-3 py-1 rounded-full text-xs">Romance</span>
        </div>
        ...
        <p className="mt-4 text-xl subtitle">
          <strong>Directed by:</strong> Goro Miyazaki
        </p>

  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url('/images/yamada.jpg')`
        }}
      />
      ...
      <div className="relative z-20 h-full text-white p-6 flex flex-col">
        ...
        <div className="flex mt-2 space-x-2 subtitle">
          <span className="bg-gray-800 bg-opacity-70 px-3 py-1 rounded-full text-xs">Comedy</span>
